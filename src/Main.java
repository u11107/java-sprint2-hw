...
public class Main {
    ...
    public static void main(String[] args) throws ManagerSaveException, IOException, InterruptedException {
        ...
        managerImpl.updateTask(new Task("123учиться", "Яндекс ", NEW));
        printAll();
        ...
        printAll();
        Subtask test7 = new Subtask(generateId(), "Завтра на работу",
        ...
        Subtask testSubtask1 = new Subtask(generateId(), "Завтра на работу",
                "А я сижу в 3 утра и пишу код", DONE, Duration.ofHours(2),
                LocalDateTime.of(2022, Month.MAY, 21, 23, 0), test6.getId());
        Subtask testSubtask2 = new Subtask(generateId(), "Я правлю код в сне",
                "я заболел java", NEW, Duration.ofHours(2),
                LocalDateTime.of(2022, Month.MAY, 21, 23, 0), test6.getId());
        Subtask testSubtask3 = new Subtask(generateId(), "Я правлю код в сне",
                "я заболел java", DONE, Duration.ofHours(2),
                LocalDateTime.of(2022, Month.MAY, 21, 23, 0), test6.getId());
        Subtask testSubtask4 = new Subtask(generateId(), "Я правлю код в сне",
                "я заболел java", DONE, Duration.ofHours(2),
                LocalDateTime.of(2022, Month.MAY, 21, 23, 0), test6.getId());
        ...
        printAll();
        Subtask testSubtask5 = new Subtask(generateId(), "Подзадача", "Добавлена ",
                DONE, Duration.ofHours(3),
                LocalDateTime.of(2022, 4, 22, 12, 0), 17);
